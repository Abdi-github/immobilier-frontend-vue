...
const { t } = useI18n();
const sections = [
    'overview', 'collection', 'usage', 'sharing',
    'cookies', 'rights', 'security', 'retention', 'contact',
];
...
const __VLS_0 = __VLS_asFunctionalComponent(SEO, new SEO({
    title: (__VLS_ctx.t('privacy.title')),
}));
...
for (const [s] of __VLS_getVForSourceType((__VLS_ctx.sections))) {
    ...
    (__VLS_ctx.t(`privacy.sections.${s}.title`));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)({
        ...{ class: "text-gray-500 leading-relaxed" },
    });
    (__VLS_ctx.t(`privacy.sections.${s}.text`));
}
