...
export function useAuth() {
    ...
    const forgotPasswordMutation = useMutation({
        mutationFn: (data) => authApi.forgotPassword(data).then((res) => res.data),
    });
    const resetPasswordMutation = useMutation({
        mutationFn: (data) => authApi.resetPassword(data).then((res) => res.data),
    });
    const verifyEmailMutation = useMutation({
        mutationFn: (data) => authApi.verifyEmail(data).then((res) => res.data),
    });
    const resendVerificationMutation = useMutation({
        mutationFn: (data) => authApi.resendVerification(data).then((res) => res.data),
    });
    return {
        loginMutation,
        registerMutation,
