            ...
            children: [
              {
                ...
                name: 'my-properties',
                component: () =>
                  import('@/features/property-management/pages/MyPropertiesPage.vue'),
              },
              {
                path: 'new',
                name: 'create-property',
                component: () =>
                  import('@/features/property-management/pages/CreatePropertyPage.vue'),
              },
              {
                path: ':id/edit',
                name: 'edit-property',
                component: () =>
                  import('@/features/property-management/pages/EditPropertyPage.vue'),
              },
            ],
          },
        ],
